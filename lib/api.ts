...
// ---------------------------------------------------------
// INTERFACES (Tipagens exigidas pelo store.tsx)
// ---------------------------------------------------------
...
// ---------------------------------------------------------
// FUNÇÕES MOCKADAS (Exportações exigidas pelo store.tsx)
// ---------------------------------------------------------
...
export async function createDevice(payload: any): Promise<Device> {
  await delay(1000);
